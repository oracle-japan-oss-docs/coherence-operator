...
<p></p>
<p><span class="merged" id="all.4e4Xw.1" title="原文 : Building a simple Coherence server image with JIB using Maven or Gradle.">MavenまたはGradleを使用して、<a href="https://github.com/GoogleContainerTools/jib/blob/master/README.md" id="" target="_blank" >JIB</a>を使用した単純なCoherenceサーバー・イメージをビルドします。</span></p>
...
<p></p>
<p><span class="merged" id="all.3BzIMm.1" title="原文 : Building a simple Coherence image with a Dockerfile, that works out of the box with the Operator.">Dockerfileを使用して単純なCoherenceイメージを作成します。このイメージは、オペレータとともにすぐに使用できます。</span></p>
...
<p></p>
<p><span class="merged" id="all.LzPx6.1" title="原文 : Securing Coherence clusters using TLS.">TLSを使用してCoherenceクラスタを保護します。</span></p>
...
<p></p>
<p><span class="merged" id="all.4et6Rg.1" title="原文 : An example covering the use of Kubernetes NetworkPolicy rules with the Operator and Coherence clusters.">Kubernetes <code>NetworkPolicy</code>ルールと、OperatorクラスタおよびCoherenceクラスタの使用について説明する例。</span></p>
...
<p></p>
<p><span class="merged" id="all.2bOPYe.1" title="原文 : Manage Coherence resources using Helm.">Helmを使用してCoherenceリソースを管理します。</span></p>
