...
<h2 id="pre"><span class="merged" id="all.2LZvWc.3"  title="原文:: Prerequisites">前提条件</span></h2>
<div class="section">
...
<h2 id="install-operator"><span class="merged" id="all.LO8kI.1" title="原文 : Install the Coherence Operator">Coherence Operatorのインストール</span></h2>
<div class="section">
