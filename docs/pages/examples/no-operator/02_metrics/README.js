...
<div class="section">
<p><span class="merged" id="all.361aPh.spl1" title="原文 : The simplest way to install Prometheus is to follow the instructions in the Prometheus Operator Quick Start page.">Prometheusをインストールする最も簡単な方法は、Prometheusオペレータの<a href="https://prometheus-operator.dev/docs/prologue/quick-start/" id="" target="_blank" >「クイック・スタート」</a>ページの指示に従うことです。</span> <span class="merged" id="all.361aPh.spl2" title="原文 : Prometheus can then be accessed as documented in the Access Prometheus section of the Quick Start page.">Prometheusには、<a href="https://prometheus-operator.dev/docs/prologue/quick-start/#access-prometheus" id="" target="_blank" >「クイック・スタートのPrometheusセクションにアクセス」</a>ページの説明に従ってアクセスできます。</span> </p>
