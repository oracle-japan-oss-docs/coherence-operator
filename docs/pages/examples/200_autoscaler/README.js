...
<p><span class="merged" id="all.1tORPP.spl1" title="原文 : The Java code in this example contains a simple MBean class HeapUsage and corresponding MBean interface HeapUsageMBean that obtain heap use metrics in the way detailed above.">この例のJavaコードには、単純なMBeanクラス<code>HeapUsage</code>と、前述の方法でヒープ使用メトリクスを取得する対応するMBeanインタフェース<code>HeapUsageMBean</code>が含まれています。</span> <span class="merged" id="all.1tORPP.spl2" title="原文 : There is also a configuration file custom-mbeans.xml that Coherence will use to automatically add the custom MBean to Coherence management and metrics.">CoherenceがカスタムMBeanをCoherence管理およびメトリクスに自動的に追加するために使用する構成ファイル<code>custom-mbeans.xml</code>もあります。</span> <span class="merged" id="all.1tORPP.spl3" title="原文 : There is Coherence documentation on how to add custom metrics and how to register custom MBeans."><a href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/manage/using-coherence-metrics.html#GUID-CFC31D23-06B8-49AF-8996-ADBA806E0DD9" id="" target="_blank" >「カスタム・メトリクスの追加方法」</a>および<a href="https://docs.oracle.com/en/middleware/fusion-middleware/coherence/14.1.2/manage/registering-custom-mbeans.html#GUID-1EE749C5-BC0D-4353-B5FE-1C5DCDEAE48C" id="" target="_blank" >「カスタムMBeansを登録する方法」</a>にCoherenceドキュメントがあります。</span> </p>
...
<h2 id="_run_the_example"><span class="merged" id="all.oJSYR.1"  title="原文:: Run the Example">サンプルの実行</span></h2>
<div class="section">
