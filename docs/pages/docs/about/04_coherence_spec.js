...
<td class=""><span class="merged" id="all.182r4C" title="原文 : This is the spec of some sort of probe to fire when the StatefulSet becomes ready">これは、StatefulSetの準備が整ったときに起動するなんらかのプローブの仕様です</span></td>
...
<td class=""><span class="merged" id="all.kbdVR" title="原文 : or this is the spec of a Job to create when the StatefulSet becomes ready">または、StatefulSetの準備ができたときに作成するジョブの仕様です</span></td>
...
<td class=""><span class="merged" id="all.1Jqvr8"  title="原文: batchv1.JobSpec"><code><a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#jobspec-v1-batch" id="" target="_blank" >batchv1.JobSpec</a></code></span></td>
...
<td class=""><span class="merged" id="all.3waFYe"  title="原文: []corev1.EnvVar"><code>[]<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#envvar-v1-core" id="" target="_blank" >corev1.EnvVar</a></code></span></td>
...
<td class=""><span class="merged" id="all.2BngJe.spl1" title="原文 : Annotations are free-form yaml that will be added to the store release as annotations Any annotations should be placed BELOW this &quot;annotations:&quot; key.">注釈は自由形式yamlで、注釈としてストア・リリースに追加されます。注釈は、この「annotations:」キーをBELOWに配置する必要があります。</span> <span class="merged" id="all.2BngJe.spl2" title="原文 : For example if we wanted to include annotations for Prometheus it would look like this: annotations: prometheus.io/scrape: &quot;true&quot; + prometheus.io/port: &quot;2408&quot; ">たとえば、Prometheusの注釈を含める場合は、次のようになります:<br><br>annotations: <br> prometheus.io/scrape:"true" +<br> prometheus.io/port: "2408"<br></span> </td>
...
<td class=""><span class="merged" id="all.RY9nx"  title="原文: []corev1.Volume"><code>[]<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core" id="" target="_blank" >corev1.Volume</a></code></span></td>
...
<td class=""><span class="merged" id="all.2VHrhf"  title="原文: []corev1.VolumeMount"><code>[]<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volumemount-v1-core" id="" target="_blank" >corev1.VolumeMount</a></code></span></td>
...
<td class=""><span class="merged" id="all.1Ks0fb"  title="原文: []corev1.PodReadinessGate"><code>[]<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#podreadinessgate-v1-core" id="" target="_blank" >corev1.PodReadinessGate</a></code></span></td>
...
<td class=""><span class="merged" id="all.2Lr11u" title="原文 : Resources is the optional resource requests and limits for the containers ref: http://kubernetes.io/docs/user-guide/compute-resources/ + The Coherence operator does not apply any default resources.">リソースはコンテナのオプションのリソース・リクエストおよび制限です<br>参照: <a href="http://kubernetes.io/docs/user-guide/compute-resources/" id="" target="_blank" >http://kubernetes.io/docs/user-guide/compute-resources/</a> +<br>Coherenceオペレータでは、デフォルト・リソースは適用されません。</span></td>
<td class=""><span class="merged" id="all.2FCMXE"  title="原文: *corev1.ResourceRequirements"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#resourcerequirements-v1-core" id="" target="_blank" >corev1.ResourceRequirements</a></code></span></td>
...
<td class=""><span class="merged" id="all.3ooOa4"  title="原文: *corev1.Affinity"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#affinity-v1-core" id="" target="_blank" >corev1.Affinity</a></code></span></td>
...
<td class=""><span class="merged" id="all.2q0Dwb"  title="原文: []corev1.Toleration"><code>[]<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#toleration-v1-core" id="" target="_blank" >corev1.Toleration</a></code></span></td>
...
<td class=""><span class="merged" id="all.3iWm8L"  title="原文: *corev1.PodSecurityContext"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#podsecuritycontext-v1-core" id="" target="_blank" >corev1.PodSecurityContext</a></code></span></td>
...
<td class=""><span class="merged" id="all.1mt8kE"  title="原文: *corev1.SecurityContext"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#securitycontext-v1-core" id="" target="_blank" >corev1.SecurityContext</a></code></span></td>
...
<td class=""><span class="merged" id="all.2Bm4w4" title="原文 : Configure various networks and DNS settings for Pods in this rolw.">このロールウのポッドの様々なネットワークおよびDNS設定を構成します。</span></td>
...
<td class=""><span class="merged" id="all.3eogG8"  title="原文: []corev1.TopologySpreadConstraint"><code>[]<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#topologyspreadconstraint-v1-core" id="" target="_blank" >corev1.TopologySpreadConstraint</a></code></span></td>
...
<td class=""><span class="merged" id="all.1zGH9t.spl1" title="原文 : LocalPort sets the Coherence unicast port.">LocalPortは、Coherenceユニキャスト・ポートを設定します。</span> <span class="merged" id="all.1zGH9t.spl2"  title="原文: When manually configuring unicast ports, a single port is specified and the second port is automatically selected.">ユニキャスト・ポートを手動で構成する場合は、単一のポートが指定され、2番目のポートが自動的に選択されます。</span> <span class="merged" id="all.1zGH9t.spl3"  title="原文: If either of the ports are not available, then the default behavior is to select the next available port.">いずれかのポートが使用できない場合、デフォルトの動作では、使用可能な次のポートを選択します。</span> <span class="merged" id="all.1zGH9t.spl4"  title="原文: For example, if port 9000 is configured for the first port (port1) and it is not available, then the next available port is automatically selected.">たとえば、ポート9000が最初のポート(port1)に構成されており、使用不可の場合、使用可能な次のポートが自動的選択されます。</span> <span class="merged" id="all.1zGH9t.spl5"  title="原文: The second port (port2) is automatically opened and defaults to the next available port after port1 (port1 + 1 if available).">2番目のポート(port2)が自動的に開き、デフォルトでport1の次に使用可能なポート(使用可能であれば、port1 + 1)として設定されます。</span> </td>
...
<td class=""><span class="merged" id="all.1yi250"  title="原文: []corev1.KeyToPath"><code>[]<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#keytopath-v1-core" id="" target="_blank" >corev1.KeyToPath</a></code></span></td>
...
<td class=""><span class="merged" id="all.3MR6UW"  title="原文: *https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core" id="" target="_blank" >https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core</a></code></span></td>
...
<td class=""><span class="merged" id="all.4OS2UV.spl1" title="原文 : The port tht the JMXMP MBeanServer should bind to.">JMXMP MBeanServerにバインドするポート。</span> <span class="merged" id="all.4OS2UV.spl2" title="原文 : If not set the default port is 9099">設定しない場合のデフォルト・ポートは9099です</span> </td>
...
<td class=""><span class="merged" id="all.1AtyVO"  title="原文: *corev1.PersistentVolumeClaimSpec"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#persistentvolumeclaimspec-v1-core" id="" target="_blank" >corev1.PersistentVolumeClaimSpec</a></code></span></td>
...
<td class=""><span class="merged" id="all.3MR6UW.1"  title="原文: *https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core" id="" target="_blank" >https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core</a></code></span></td>
...
<td class=""><span class="merged" id="all.1AtyVO.1"  title="原文: *corev1.PersistentVolumeClaimSpec"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#persistentvolumeclaimspec-v1-core" id="" target="_blank" >corev1.PersistentVolumeClaimSpec</a></code></span></td>
...
<td class=""><span class="merged" id="all.3MR6UW.2"  title="原文: *https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core" id="" target="_blank" >https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#volume-v1-core</a></code></span></td>
...
<td class=""><span class="merged" id="all.3kDDnR"  title="原文: corev1.PersistentVolumeClaimSpec"><code><a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#persistentvolumeclaimspec-v1-core" id="" target="_blank" >corev1.PersistentVolumeClaimSpec</a></code></span></td>
...
<td class=""><span class="merged" id="all.2albce.spl1" title="原文 : Name must be unique within a namespace.">名前はネームスペース内で一意である必要があります。</span> <span class="merged" id="all.2albce.spl2" title="原文 : Is required when creating resources, although some resources may allow a client to request the generation of an appropriate name automatically.">リソースの作成時に必要になりますが、一部のリソースでは、クライアントが適切な名前の生成を自動的にリクエストできる場合があります。</span> <span class="merged" id="all.2albce.spl3" title="原文 : Name is primarily intended for creation idempotence and configuration definition.">名前は主に、べき等の作成および構成定義を目的としています。</span> <span class="merged" id="all.2albce.spl4"  title="原文:: Cannot be updated.">更新できません</span> <span class="merged" id="all.2albce.spl5" title="原文 : More info: http://kubernetes.io/docs/user-guide/identifiers#names">詳細情報: <a href="http://kubernetes.io/docs/user-guide/identifiers#names" id="" target="_blank" >http://kubernetes.io/docs/user-guide/identifiers#names</a></span> </td>
...
<td class=""><span class="merged" id="all.4ODu0c.spl1" title="原文 : Map of string keys and values that can be used to organize and categorize (scope and select) objects.">オブジェクトの編成および分類(スコープおよび選択)に使用できる文字列キーおよび値のマップ。</span> <span class="merged" id="all.4ODu0c.spl2" title="原文 : May match selectors of replication controllers and services.">レプリケーション・コントローラとサービスのセレクタを一致させることができます。</span> <span class="merged" id="all.4ODu0c.spl3" title="原文 : More info: http://kubernetes.io/docs/user-guide/labels">詳細情報: <a href="http://kubernetes.io/docs/user-guide/labels" id="" target="_blank" >http://kubernetes.io/docs/user-guide/labels</a></span> </td>
...
<td class=""><span class="merged" id="all.qbYoM.spl1" title="原文 : Annotations is an unstructured key value map stored with a resource that may be set by external tools to store and retrieve arbitrary metadata.">注釈は、任意のメタデータを格納および取得するために外部ツールで設定できるリソースとともに格納される非構造化キー値マップです。</span> <span class="merged" id="all.qbYoM.spl2" title="原文 : They are not queryable and should be preserved when modifying objects.">これらはクエリー可能ではなく、オブジェクトを変更するときに保持する必要があります。</span> <span class="merged" id="all.qbYoM.spl3" title="原文 : More info: http://kubernetes.io/docs/user-guide/annotations">詳細情報: <a href="http://kubernetes.io/docs/user-guide/annotations" id="" target="_blank" >http://kubernetes.io/docs/user-guide/annotations</a></span> </td>
...
<td class=""><span class="merged" id="all.Ww5Gw"  title="原文: []corev1.PodDNSConfigOption"><code>[]<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#poddnsconfigoption-v1-core" id="" target="_blank" >corev1.PodDNSConfigOption</a></code></span></td>
...
<td class=""><span class="merged" id="all.2bI7LZ"  title="原文: *corev1.ExecAction"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#execaction-v1-core" id="" target="_blank" >corev1.ExecAction</a></code></span></td>
...
<td class=""><span class="merged" id="all.4TQyOD"  title="原文: *corev1.HTTPGetAction"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#httpgetaction-v1-core" id="" target="_blank" >corev1.HTTPGetAction</a></code></span></td>
...
<td class=""><span class="merged" id="all.j1V4s"  title="原文: *corev1.TCPSocketAction"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#tcpsocketaction-v1-core" id="" target="_blank" >corev1.TCPSocketAction</a></code></span></td>
...
<td class=""><span class="merged" id="all.2bI7LZ.1"  title="原文: *corev1.ExecAction"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#execaction-v1-core" id="" target="_blank" >corev1.ExecAction</a></code></span></td>
...
<td class=""><span class="merged" id="all.4TQyOD.1"  title="原文: *corev1.HTTPGetAction"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#httpgetaction-v1-core" id="" target="_blank" >corev1.HTTPGetAction</a></code></span></td>
...
<td class=""><span class="merged" id="all.j1V4s.1"  title="原文: *corev1.TCPSocketAction"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#tcpsocketaction-v1-core" id="" target="_blank" >corev1.TCPSocketAction</a></code></span></td>
...
<td class=""><span class="merged" id="all.1yi250.1"  title="原文: []corev1.KeyToPath"><code>[]<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#keytopath-v1-core" id="" target="_blank" >corev1.KeyToPath</a></code></span></td>
...
<td class=""><span class="merged" id="all.2IpEis.spl1" title="原文 : Additional labels to add to the ServiceMonitor.">ServiceMonitorに追加する追加のラベル。</span> <span class="merged" id="all.2IpEis.spl2" title="原文 : More info: http://kubernetes.io/docs/user-guide/labels">詳細情報: <a href="http://kubernetes.io/docs/user-guide/labels" id="" target="_blank" >http://kubernetes.io/docs/user-guide/labels</a></span> </td>
...
<td class=""><span class="merged" id="all.37EARl"  title="原文: corev1.SecretKeySelector"><code><a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#secretkeyselector-v1-core" id="" target="_blank" >corev1.SecretKeySelector</a></code></span></td>
...
<td class=""><span class="merged" id="all.1tPEcY.spl1" title="原文 : The extra labels to add to the service.">サービスに追加する追加ラベル。</span> <span class="merged" id="all.1tPEcY.spl2" title="原文 : More info: http://kubernetes.io/docs/user-guide/labels">詳細情報: <a href="http://kubernetes.io/docs/user-guide/labels" id="" target="_blank" >http://kubernetes.io/docs/user-guide/labels</a></span> </td>
...
<td class=""><span class="merged" id="all.C5sgP.18"  title="原文: *int32"><code>*int32</code></span></td>
...
<td class=""><span class="merged" id="all.3ywto1"  title="原文: *corev1.SessionAffinityConfig"><code>*<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#sessionaffinityconfig-v1-core" id="" target="_blank" >corev1.SessionAffinityConfig</a></code></span></td>
...
<td class="">&#160;</td>
<td class=""><span class="merged" id="all.1GvJgW"  title="原文: metav1.ObjectMeta"><code><a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#objectmeta-v1-meta" id="" target="_blank" >metav1.ObjectMeta</a></code></span></td>
...
<td class="">&#160;</td>
<td class=""><span class="merged" id="all.4feKAl"  title="原文: metav1.ListMeta"><code><a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.24/#listmeta-v1-meta" id="" target="_blank" >metav1.ListMeta</a></code></span></td>
...
<td class=""><span class="merged" id="all.31rVFp.spl1" title="原文 : label query over deployments that should match the replicas count.">レプリカ数と一致するデプロイメントに対するラベルクエリー。</span> <span class="merged" id="all.31rVFp.spl2" title="原文 : This is same as the label selector but in the string format to avoid introspection by clients.">これはラベル・セレクタと同じですが、クライアントによるイントロスペクションを回避するための文字列形式です。</span> <span class="merged" id="all.31rVFp.spl3" title="原文 : The string will be in the same format as the query-param syntax.">文字列はquery-param構文と同じ形式になります。</span> <span class="merged" id="all.31rVFp.spl4" title="原文 : More info about label selectors: http://kubernetes.io/docs/user-guide/labels#label-selectors">ラベル・セレクタの詳細: <a href="http://kubernetes.io/docs/user-guide/labels#label-selectors" id="" target="_blank" >http://kubernetes.io/docs/user-guide/labels#label-selectors</a></span> </td>
