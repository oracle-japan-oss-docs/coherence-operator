...
<td class=""><code>*<router-link @click.native="this.scrollFix('#_imagespec')" to="#_imagespec">ImageSpec</router-link></code></td>
...
<td class=""><code>*<a href="https://pkg.go.dev/k8s.io/api/core/v1#ServiceExternalTrafficPolicyType" id="" target="_blank" >https://pkg.go.dev/k8s.io/api/core/v1#ServiceExternalTrafficPolicyType</a></code></td>
...
<td class=""><code>*<a href="https://pkg.go.dev/k8s.io/api/core/v1#IPFamilyPolicyType" id="" target="_blank" >https://pkg.go.dev/k8s.io/api/core/v1#IPFamilyPolicyType</a></code></td>
