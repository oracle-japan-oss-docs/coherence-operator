...
<h2 id="_ssl_with_metrics"><span class="merged" id="all.2wFQwE" title="原文 : SSL with Metrics">メトリクスによるSSL</span></h2>
<div class="section">
...
<ul class="colist">
<li data-value="1"><span class="merged" id="all.FuYcg.1" title="原文 : The enabled field when set to true enables SSL for metrics or when set to false disables SSL"><code>enabled</code>フィールドを<code>true</code>に設定すると、メトリクスに対してSSLが有効になるか、<code>false</code>に設定するとSSLが無効になります</span></li>
<li data-value="2"><span class="merged" id="all.2kW9G2.1" title="原文 : The keyStore field sets the name of the Java key store file that should be used to obtain the server&rsquo;s key"><code>keyStore</code>フィールドでは、サーバーのキーに使用するJavaキー・ストア・ファイルの名前を設定</span></li>
<li data-value="3"><span class="merged" id="all.N3g8j.1" title="原文 : The optional keyStoreType field sets the type of the key store file, the default value is JKS">オプションの<code>keyStoreType</code>フィールドは、キー・ストア・ファイルのタイプを設定します。デフォルト値は<code>JKS</code>です</span></li>
...
<li data-value="7"><span class="merged" id="all.R70o2.1" title="原文 : The optional keyStoreAlgorithm sets the algorithm name for the key store, the default value is SunX509">オプションの<code>keyStoreAlgorithm</code>はキー・ストアのアルゴリズム名を設定します。デフォルト値は<code>SunX509</code>です</span></li>
<li data-value="8"><span class="merged" id="all.yx8Wj.1" title="原文 : The trustStore field sets the name of the Java trust store file that should be used to obtain the server&rsquo;s key"><code>trustStore</code>フィールドでは、サーバーのキーに使用するJavaトラスト・ストア・ファイルの名前を設定</span></li>
