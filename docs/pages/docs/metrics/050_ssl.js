...
<li data-value="2"><span class="merged" id="all.2kW9G2.1" title="原文 : The keyStore field sets the name of the Java key store file that should be used to obtain the server’s key"><code>keyStore</code>フィールドでは、サーバーのキーに使用するJavaキー・ストア・ファイルの名前を設定</span></li>
...
<li data-value="8"><span class="merged" id="all.yx8Wj.1" title="原文 : The trustStore field sets the name of the Java trust store file that should be used to obtain the server’s key"><code>trustStore</code>フィールドでは、サーバーのキーに使用するJavaトラスト・ストア・ファイルの名前を設定</span></li>
