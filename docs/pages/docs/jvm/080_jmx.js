...
<ul class="colist">
<li data-value="1"><span class="merged" id="all.1tjJZV" title="原文 : JMXMP is enabled so that a JMXMP server will be started in the Coherence container&rsquo;s JVM">JMXMPは、JMXMPサーバーがCoherenceコンテナのJVMで起動されるように有効です</span></li>
