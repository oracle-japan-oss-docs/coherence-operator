...
<div class="section">
<p><span class="merged" id="all.16tSKD" title="原文 : There are a number of management and diagnostic features available with Oracle Coherence that can be used in a cluster deployed in Kubernetes.">Kubernetesにデプロイされたクラスタで使用できる、Oracle Coherenceで使用できる管理および診断の機能が多数あります。</span></p>
...
</router-link> <v-card-title primary class="headline layout justify-center"><span style="text-align:center">RESTの管理</span></v-card-title> <v-card-text class="caption">
<p></p>
<p><span class="merged" id="all.1I4dSJ" title="原文 : Coherence Management over REST feature">REST機能でのCoherence管理</span></p>
</v-card-text> </v-card> </v-flex> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/docs/management/030_visualvm"><div class="card__link-hover"/>
...
<p></p>
<p><span class="merged" id="all.28fS2p" title="原文 : Enable SSL on the Management over REST endpoint.">Management over RESTエンドポイントでSSLを有効にします。</span></p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
