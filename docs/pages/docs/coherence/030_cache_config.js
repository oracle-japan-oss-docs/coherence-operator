...
<p><span class="merged" id="all.w9voH.spl1" title="原文 : When the spec.coherence.cacheConfig is blank or not specified, Coherence use its default behaviour to find the cache configuration file to use."><code>spec.coherence.cacheConfig</code>が空白であるか指定されていない場合、Coherenceはデフォルトの動作を使用して、使用するキャッシュ構成ファイルを検索します。</span> <span class="merged" id="all.w9voH.spl2" title="原文 : Typically, this is to use the first occurrence of coherence-cache-config.xml that is found on the classpath (consult the Coherence documentation for an explanation of the default behaviour).">通常、これは、クラスパスで最初に見つかった<code>coherence-cache-config.xml</code>を使用することです(デフォルトの動作の説明については、<a href="https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/develop-applications/understanding-configuration.html#GUID-360B798E-2120-44A9-8B09-1FDD9AB40EB5" id="" target="_blank" >「Coherenceのドキュメント」</a>を使用します)。</span> </p>
