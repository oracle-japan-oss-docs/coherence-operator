...
<p><span class="merged" id="all.1nflyq.spl1" title="原文 : When the spec.coherence.overrideConfig is blank or not specified, Coherence use its default behaviour to find the operational configuration file to use."><code>spec.coherence.overrideConfig</code>が空白であるか指定されていない場合、Coherenceはデフォルトの動作を使用して、使用する操作構成ファイルを検索します。</span> <span class="merged" id="all.1nflyq.spl2" title="原文 : Typically, this is to use the first occurrence of tangosol-coherence-override.xml that is found on the classpath (consult the Coherence documentation for an explanation of the default behaviour).">通常、これは、クラスパスで最初に見つかった<code>tangosol-coherence-override.xml</code>を使用することです(デフォルトの動作の説明については、<a href="https://docs.oracle.com/en/middleware/standalone/coherence/14.1.1.0/develop-applications/understanding-configuration.html#GUID-360B798E-2120-44A9-8B09-1FDD9AB40EB5" id="" target="_blank" >「Coherenceのドキュメント」</a>を使用します)。</span> </p>
