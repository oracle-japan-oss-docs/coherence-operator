...
<p><span class="merged" id="all.2S5gkW" title="原文 : There are many ways to configure Fluentd, the example above is just one way and is in fact taken from one of the Operator&rsquo;s functional tests.">Fluentdを構成する方法は数多くありますが、前述の例は1つの方法にすぎず、実際はOperatorの機能テストの1つ。</span></p>
