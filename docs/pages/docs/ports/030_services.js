...
<p><span class="merged" id="all.3HAusk" title="原文 : See the Coherence CRD Service Spec documentation and the Kubernetes Service API reference."><code>Coherence</code> CRD <router-link :to="{path: '/docs/about/04_coherence_spec', hash: '#_servicespec'}">「サービス仕様」</router-link>ドキュメントおよびKubernetes <a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/${k8s-doc-version}/#servicespec-v1-core" id="" target="_blank" >「Service APIリファレンス」</a>を参照してください。</span></p>
