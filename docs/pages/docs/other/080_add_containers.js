...
<p><span class="merged" id="all.4Re7rV.spl1" title="原文 : The containers will added to the sideCars will be added to the Pods exactly as configured.">コンテナは<code>sideCars</code>に追加され、構成済と正確に<code>Pods</code>に追加されます。</span> <span class="merged" id="all.4Re7rV.spl2" title="原文 : Any configuration that is valid in a Kubernetes Container Spec may be added to an entry in sideCars">Kubernetes <a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/${k8s-doc-version}/#container-v1-core" id="" target="_blank" >「コンテナ仕様」</a>で有効な構成はすべて、<code>sideCars</code>のエントリに追加できます</span> </p>
