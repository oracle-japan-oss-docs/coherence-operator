...
<div class="section">
<p><span class="merged" id="all.4cewzA.spl1" title="原文 : To specify security settings for a Pod, include the securityContext field in the Coherence resource specification.">ポッドのセキュリティ設定を指定するには、Coherenceリソース仕様に<code>securityContext</code>フィールドを含めます。</span> <span class="merged" id="all.4cewzA.spl2" title="原文 : The securityContext field is a PodSecurityContext object.">securityContextフィールドは<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/${k8s-doc-version}/#podsecuritycontext-v1-core" id="" target="_blank" >PodSecurityContext</a>オブジェクトです。</span> <span class="merged" id="all.4cewzA.spl3" title="原文 : The security settings that you specify for a Pod apply to all Containers in the Pod.">ポッドに指定したセキュリティ設定は、ポッド内のすべてのコンテナに適用されます。</span> <span class="merged" id="all.4cewzA.spl4" title="原文 : Here is a configuration file for a Pod that has a securityContext:">securityContextを持つポッドの構成ファイルを次に示します:</span> </p>
...
<div class="section">
<p><span class="merged" id="all.4a2Z6o.spl1" title="原文 : To specify security settings for the Coherence container within the Pods, include the containerSecurityContext field in the Container manifest.">ポッド内のCoherenceコンテナのセキュリティ設定を指定するには、コンテナ・マニフェストに<code>containerSecurityContext</code>フィールドを含めます。</span> <span class="merged" id="all.4a2Z6o.spl2" title="原文 : The containerSecurityContext field is a SecurityContext object."><code>containerSecurityContext</code>フィールドは<a href="https://kubernetes.io/docs/reference/generated/kubernetes-api/${k8s-doc-version}/#securitycontext-v1-core" id="" target="_blank" >SecurityContext</a>オブジェクトです。</span> <span class="merged" id="all.4a2Z6o.spl3" title="原文 : Security settings that you specify in the containerSecurityContext field apply only to the individual Coherence container and the Operator init-container, and they override settings made at the Pod level in the securityContext field when there is overlap."><code>containerSecurityContext</code>フィールドに指定するセキュリティ設定は、個々のCoherenceコンテナおよびOperator init-containerにのみ適用され、重複がある場合は、<code>securityContext</code>フィールドのポッド・レベルで行った設定をオーバーライドします。</span> <span class="merged" id="all.4a2Z6o.spl4" title="原文 : Container settings do not affect the Pod’s Volumes.">コンテナ設定はポッドのボリュームに影響しません。</span> </p>
