...
>curl -L https://github.com/oracle/coherence-operator/releases/download/v3.5.1/coherence-operator.yaml \
...
<h4 id="_install_using_helm"><span class="merged" id="all.4g555R.2" title="原文 : Install Using Helm">Helmを使用したインストール</span></h4>
<div class="section">
...
<p class="admonition-textlabel"><span class="merged" id="all.2dRYIU.3"  title="原文:: Warning">警告</span></p>
...
<h4 id="_install_using_helm_2"><span class="merged" id="all.4g555R.3" title="原文 : Install Using Helm">Helmを使用したインストール</span></h4>
<div class="section">
