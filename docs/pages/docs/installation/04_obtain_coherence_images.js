...
<p><span class="merged" id="all.1pk54t" title="原文 : Also see Using Private Image Registries"><router-link to="/docs/installation/05_private_repos">「プライベート・イメージ・レジストリの使用」</router-link>も参照してください</span></p>
