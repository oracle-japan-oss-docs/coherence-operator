...
<div class="section">
<p><span class="merged" id="all.2v1PLt" title="原文 : The two methods of installing the Operator discussed in the Install Guide can be used to install the Operator without ClusterRoles."><router-link to="/docs/installation/001_installation">「インストール・ガイド」</router-link>で説明したオペレータをインストールする2つのメソッドを使用して、ClusterRolesを使用せずにオペレータをインストールできます。</span></p>
...
<p><span class="merged" id="all.2QH2cb" title="原文 : The manifest files are published with the GitHub release at this link: 3.3.5 Manifests">マニフェスト・ファイルは、このリンクでGitHubリリースとともに公開されます: <a href="https://github.com/oracle/coherence-operator/releases/download/v3.5.1/coherence-operator-manifests.tar.gz" id="" target="_blank" >3.3.5 マニフェスト</a></span></p>
...
<h3 id="_install_using_helm"><span class="merged" id="all.4g555R.1" title="原文 : Install Using Helm">Helmを使用したインストール</span></h3>
<div class="section">
<p><span class="merged" id="all.3XTQxR.spl1" title="原文 : The Operator can be installed from the Helm chart, as described in the Install Guide.">オペレータは、<router-link to="/docs/installation/001_installation">「インストール・ガイド」</router-link>の説明に従ってHelmチャートからインストールできます。</span> <span class="merged" id="all.3XTQxR.spl2" title="原文 : The Helm chart contains values that control whether cluster roles are created when installing the chart.">Helmチャートには、チャートのインストール時にクラスタ・ロールを作成するかどうかを制御する値が含まれています。</span> <span class="merged" id="all.3XTQxR.spl3" title="原文 : To install the chart without any cluster roles set the clusterRoles value to false.">クラスタ・ロールなしでチャートをインストールするには、<code>clusterRoles</code>値を<code>false</code>に設定します。</span> </p>
...
<h3 id="_install_using_kustomize"><span class="merged" id="all.42E3lU.1" title="原文 : Install Using Kustomize">Kustomizeを使ってインストール</span></h3>
<div class="section">
<p><span class="merged" id="all.23q1S5" title="原文 : The Operator can be installed using Kustomize with the manifest files, as described in the Install Guide.">オペレータは、<router-link to="/docs/installation/001_installation">「インストール・ガイド」</router-link>で説明されているように、マニフェスト・ファイルとともにKustomizeを使用してインストールできます。</span></p>
