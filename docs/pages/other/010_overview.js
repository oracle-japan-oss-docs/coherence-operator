...
<div class="section">
<p><span class="merged" id="all.28JrWp" title="原文 : There are a number of miscellaneous configuration settings that can be added to containers and Pods controlled by the Coherence Operator.">コンテナに追加できるその他多くの構成設定と、Coherence Operatorによって制御される<code>Pods</code>があります。</span></p>

<v-layout row wrap class="mb-5"> <v-flex xs12> <v-container fluid grid-list-md class="pa-0"> <v-layout row wrap class="pillars"> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/other/020_environment"><div class="card__link-hover"/>
...
</v-card-text> </v-card> </v-flex> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/other/030_labels"><div class="card__link-hover"/>
...
</v-card-text> </v-card> </v-flex> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/other/040_annotations"><div class="card__link-hover"/>
...
<p></p>
<p><span class="merged" id="all.2JaCzM" title="原文 : Adding Pod annotations.">ポッド注釈の追加。</span></p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
...
<div class="section">
<v-layout row wrap class="mb-5"> <v-flex xs12> <v-container fluid grid-list-md class="pa-0"> <v-layout row wrap class="pillars"> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/other/080_add_containers"><div class="card__link-hover"/>
...
<div class="section">
<v-layout row wrap class="mb-5"> <v-flex xs12> <v-container fluid grid-list-md class="pa-0"> <v-layout row wrap class="pillars"> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/other/070_add_volumes"><div class="card__link-hover"/>
...
<p></p>
<p><span class="merged" id="all.sbLyh" title="原文 : Adding Volumes and volume mounts.">ボリュームとボリューム・マウントの追加。</span></p>
</v-card-text> </v-card> </v-flex> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/other/050_configmap_volumes"><div class="card__link-hover"/>
...
</v-card-text> </v-card> </v-flex> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/other/060_secret_volumes"><div class="card__link-hover"/>
...
<div class="section">
<v-layout row wrap class="mb-5"> <v-flex xs12> <v-container fluid grid-list-md class="pa-0"> <v-layout row wrap class="pillars"> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/other/090_pod_scheduling"><div class="card__link-hover"/>
...
</v-card-text> </v-card> </v-flex> <v-flex xs12 sm4 lg3> <v-card> <router-link to="/other/100_resources"><div class="card__link-hover"/>
...
<p></p>
<p><span class="merged" id="all.1uQm5N" title="原文 : Configuring Coherence container resource constraints.">Coherenceコンテナ・リソースの制約の構成。</span></p>
</v-card-text>
</v-card>
</v-flex>
</v-layout>
