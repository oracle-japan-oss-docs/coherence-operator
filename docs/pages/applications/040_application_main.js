...
<ul class="colist">
<li data-value="1"><span class="merged" id="all.3AcTG6" title="原文 : The com.acme.Catalogue will be run as the main class."><code>com.acme.Catalogue</code>は、メイン・クラスとして実行されます。</span></li>
</ul>
